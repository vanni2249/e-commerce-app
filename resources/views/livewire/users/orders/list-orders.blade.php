<div class="space-y-2">
    @foreach ($orders as $order)
        <a href="{{ route('orders.show', $order) }}" class=" bg-blue-50 hover:bg-blue-100 block p-2 md:p-4 rounded-xl">
            <div class="flex space-x-4 items-start">
                ...
                <ul class="grow">
                    <li class="text-xs">Order #{{ $order->id }}</li>
                    <li class="text-gray-500 text-xs">Placed on January 1, 2023</li>
                    <li class="text-sm font-bold">${{ $order->sales->sum('price') }}</li>
                </ul>
