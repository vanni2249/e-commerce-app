                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex gap-2">
                        @if ($admin)
                            ...
                            <x-icon-link href="{{ route('admin.items.edit', ['item' => $item]) }}" icon="pencil" wire:navigate/>
                        @else
                            <x-icon-button icon="eye" />
                            <x-icon-link href="{{ route('sellers.items.edit', ['item' => $item]) }}" icon="pencil" wire:navigate/>
                        @endif
                    </div>
                </div>
                <div>
