        ...
        <div class="col-span-full lg:col-span-full">
            <x-card class="h-full rounded-xl">
                <header class="flex justify-between items-center mb-4">
                    <h1 class="text-lg font-bold">Claims</h1> 
                ...
                <x-table>
                    ...
                    <x-slot name="body">
                        ...
                        <tr class="border-t border-gray-200">
                            <td class="px-4 py-1">
                                <a href="{{ route('admin.claims.show', rand(1, 100)) }}" class="text-blue-600 hover:underline">
                                    {{ rand(100000, 999999) }}
                                </a>
                            </td>
                            <td class="px-4 py-1">
                            ...
                            <td class="px-4 py-1">
                                {{ rand(0, 1) ? 'Product Issue' : 'Shipping Issue' }}
                            </td>
                            <td class="px-4 py-1">
                            ...
                            <td class="px-4 py-1 flex justify-end">
                                <x-icon-link href="{{ route('admin.claims.show', rand(1, 100)) }}" icon="eye" />
                            </td>
                        </tr>
                        @endfor
                    </x-slot>
